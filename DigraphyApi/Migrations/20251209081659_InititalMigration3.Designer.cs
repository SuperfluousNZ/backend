...
namespace DigraphyApi.Migrations
{
    ...
    [Migration("20251209081659_InititalMigration3")]
    partial class InititalMigration3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigraphyApi.Models.OrderTitle", b =>
                {
                    b.HasOne("DigraphyApi.Models.Order", "Order")
                        .WithMany("OrderTitles")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigraphyApi.Models.Title", "Title")
